...
var potentialSecondLevelFriends = secondLevelFriends.filter(friends => isNotAFriend(friends));
var allPotentialFriends = allUsers.filter(friends => isNotAFriend(friends))
